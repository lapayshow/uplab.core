...
class __MODULE_ID_UNDERSCORE__ extends CModule
{
	public $MODULE_ID           = "__MODULE_ID__";
	...
	public function installDB()
	{
		...
		foreach ($this->entityList as $entity) {
			/** @var Uplab\Core\Orm\OrmTrait $entityClass */
			$entityClass = "\\__MODULE_NAMESPACE__\\{$entity}\{$entity}Table";
